// CimBlock_naive: same wrapper as CimBlock but instantiates CimMacro_naive.

module CimBlock_naive #(
    ...
    // --- Input register stage (identical to CimBlock) ---
    logic                        cim_wen_reg;
